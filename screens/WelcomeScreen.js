    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.buttonBox}>
          <Text style={{color:'red', fontSize:18, fontWeight:'bold',marginLeft:55}}>EMAIL ID</Text>
          ...
          <Text style={{color:'red', fontSize:18, fontWeight:'bold',marginLeft:55}}>PASSWORD</Text>
          <View style={{alignItems:'center'}}>
            <TextInput
              style={styles.loginBox}
              secureTextEntry = {true}
